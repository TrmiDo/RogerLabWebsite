...
const  BlogDetailsPage = () => {
  const item2029=[
 'Li CY, Bleibel N., Lara C, Luo Y, Rey A, Li BZ, Chat SW, Levi DM, Li RW. (2025) Playing stereoscopic video games enhances the precision, but not the accuracy of depth perception. ARVO, Salt Lake City, Utah, USA.',
...
'Levi DM, Li RW. (2019) Playing 3-dimensional (3D), but not 2D video games can improve stereoacuity in neurotypical observers. Vision Sciences Society, St. Pete Beach, FL.',
...
'Chung STL, Li RW, Silver MA, Levi DM. (2017) Combining the cholinesterase inhibitor donepezil with perceptual learning in adults with amblyopia. Vision Sciences Society. St. Pete Beach, FL, USA [Talk]',
...
'Cheong AMY, Lam HY, Tsang WWN, Leat SJ, Li RW. (May 2016) Slow-pace videogames are more effective than fast-pace videogames in enhancing visual attention in older adults. ARVO, Seattle, WA, USA.',
  ...
  const items2014 =[
'Tran KD, Bui, J, Yang E, Moghtaderi A, Ngo CV, Chat S, Kee, C, Levi DM, Li RW. (Oct 2015) Effect of induced astigmatic blur on the spatial frequency tuning of stereopsis. American Academy of Optometry, New Orleans, LA ,USA',
'Cheong AMY, Lam HY, Siong KH, Ting PWK, Tsang WWN, Leat SJ, Li RW. (Oct 2015) Dynamic visual acuity in community dwelling older adults. American Academy of Optometry, New Orleans, LA ,USA',
'Cheong AMY, Lam HY, Siong KH, Chan HHL, Tsang WWN, Li RW, Leat SJ. (Oct 2015) Effects of eye movements on postural sway in community dwelling older adults. American Academy of Optometry, New Orleans, LA ,USA',
...
'Li RW, Gustafson, K., Chat, S., & Levi DM (May 2012) Towards establishing a new treatment protocol for improving stereovision in patients with amblyopia. ARVO, Fort Lauderdale, FL, USA.',
'Chung, S. T. L., Li RW, Levi, D. M (May 2012) A "fuller" report on mislocation errors in visual crowding. Vision Sciences Society. Naple, FL, USA',
'Astle, A. T., Li RW, McGraw, P. V., Webb, B. S. & Levi,  D. M. (Dec 2011) The magnitude of perceptual learning is equated when stimuli are scaled according to cortical magnification factor. Applied Vision Association meeting AVA. York, UK',
  ...
  const items2009 = [
'Li RW, Luu, J., Ngo C, Yuen, J., Yang, S. X., Wong, C., Chat, S. W. & Levi DM (Nov 2010) Improving stereoacuity in previously treated non-strabismic amblyopia through perceptual learning: A novel treatment approach for subnormal stereopsis. American Academy of Optometry. San Francisco, CA, USA.',
'Chat, S. W., Li RW, Jang E., & Levi DM (May 2010) Reduced sampling efficiency can explain the elevated Vernier threshold with aging: Vernier acuity in positional noise. ARVO, Fort Lauderdale, FL, USA.',
'Li RW, Ngo C, Chat, S. W., & Levi DM (Nov 2009) Reduced sampling efficiency can explain the elevated Vernier threshold with aging: Vernier acuity in positional noise. American Academy of Optometry. Orlando, FL, USA.',
'*Ngo C, Li RW, Wei, L., & Levi DM (Nov 2009) The Specificity of Learning Static and Dynamic Bisection Acuity: Speed and Configural Orientations. American Academy of Optometry. Orlando, FL, USA.',
'Chung, S. T. L., Li RW, Levi, D. M & Behnam N. (May 2009) Improving acuity and reducing crowding in strabismic amblyopia through perceptual learning. ARVO, Fort Lauderdale, FL, USA.',
'* Ngo C, Li RW, Wei, L., Ren D., Jang E., & Levi DM (May 2009) Improving Static and Dynamic Bisection Acuity through Perceptual Learning. ARVO, Fort Lauderdale, FL, USA.',
'* Ngo C, Li RW, Levi DM, & Saarinen J. (Oct 2008). The specificity of learning position discrimination: noise and stimulus feature. American Academy of Optometry. Anaheim, CA, USA.',
'Li RW, Ngo C, Nguyen, J., Lam, J., & Levi DM (April 2008) Playing video game enhances visual acuity and visual attention in adult amblyopia. ARVO, Fort Lauderdale, FL, USA. [Paper]',
'Li RW, & Levi DM (Oct 2007) Extended perceptual learning of Vernier acuity in adult amblyopia: An intensive amblyopia treatment study. American Academy of Optometry. Tempa, FL, USA.',
'Li RW, Provost, A., & Levi DM (Oct 2007) Extended perceptual learning results in substantial recovery of positional and visual acuities in juvenile amblyopia. American Academy of Optometry. Tempa, FL, USA.',
'Chung, S. T. L., Li RW, Levi DM & Je. E (Oct 2007) Improvement in sensitivity in identifying low-contrast letters following perceptual learning in observers with amblyopia. American Academy of Optometry. Tempa, FL, USA.',
...
'Levi DM & Li RW (May 2007) Psychophysical reverse correlation – a new tool for learning about learning in normal and amblyopic vision. Vision Sciences Society. Sarasota, FL, USA.',
'Li RW, & Levi DM (May 2007) “Slow” perceptual learning of Vernier acuity in adult amblyopia: An intensive amblyopia treatment study. ARVO, Fort Lauderdale, FL, USA.',
'Li RW, Provost, A., Nguyen, J., Young, K. G., Levi DM, & Hoenig, P. (May 2006). The limits of perceptual learning in previously untreated amblyopia: an intensive case study. Vision Sciences Society. Sarasota, FL, USA.',
'Kumar, M., Li RW, Levi, D. M, Chat, S. W., & MacKeben, M. (May 2006). Decreasing visual subitising performance with age. Vision Sciences Society. Sarasota, FL, USA.',
'Chung, S. T. L.., Li RW, & Levi DM (May 2006). Performance for identifying contrast-defined letters in adults with amblyopia benefits from perceptual learning. ARVO, Fort Lauderdale, FL, USA.',
'Chung, S. T. L.., Li RW, & Levi DM (May 2006). Crowding between first- and second-order letter stimuli. Vision Sciences Society. Sarasota, FL, USA.',
  ]


 const items2004 = [
'* Li RW, Nguyen, J., Provost, A., Young, K. G., Hoenig, P., & Levi DM (Dec 2005). The limits of perceptual learning in a previously untrained amblyope: an intensive case study. American Academy of Optometry. San Diego, CA, USA.',
'Li RW, Young, K. G., Hoenig, P., Nguyen, J. & Levi DM (May 2005). Perceptual learning improves visual performance in children with amblyopia. ARVO, Fort Lauderdale, FL, USA.',
'* Young, K. G., Li RW, Levi DM, & Klein SA (May 2005). Interocular specificity in perceptual learning of a position discrimination task. ARVO, Fort Lauderdale, FL, USA.',
'Chung, S. T. L., Levi DM, & Li RW (May 2005). Learning to identify contrast-defined letters in peripheral vision. Vision Sciences Society. Sarasota, FL, USA',
'Li RW, & Levi DM (April 2004). Characterizing the mechanisms of improvement for position discrimination in adult amblyopia. ARVO, Fort Lauderdale, FL, USA.',
'* Young, K. G., Li RW, Levi DM, Klein SA, & Huang, E. Y. (April 2004). Interocular transfer in perceptual learning of a Vernier task. ARVO, Fort Lauderdale, FL, USA.',
'Li RW, Levi DM, & Klein S. A.  (May 2003). Spatial noise provides new insights into the “receptive field” for Vernier acuity. Vision Sciences Society. Sarasota, FL, USA',
...
'Li RW & Levi DM (October 2002). Mechanisms of perceptual learning for Vernier acuity. Fall Vision Meeting. San Francisco, CA, USA ',
