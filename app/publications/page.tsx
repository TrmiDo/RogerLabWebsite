...
const BlogDetailsPage = () => {
  const item2029=[
    'Li RW, Li BZ, Chat SW & Levi DM (2025, In Press) Playing stereoscopic video games enhances the precision but not the accuracy of depth perception. Scientific Reports',
