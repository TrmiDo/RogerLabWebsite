...
const BlogDetailsPage = () => {
  const item2029 = [
    'Li RW, Li BZ, Chat SW & Levi DM (2024) Playing stereoscopic video games enhances the precision but not the accuracy of depth perception. Scientific Reports, 14, e31709.', 
