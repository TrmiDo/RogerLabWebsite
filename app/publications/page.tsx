...
const BlogDetailsPage = () => {
  const item2029=[
        'Li RW, Li BZ, Chat SW, Levi DM (2024) Playing three-dimensional video games enhances the precision but not the accuracy of depth perception. Scientific Reports, 14, e31709.',    
                ...
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  ...
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60]  sm:aspect-[97/44]">
                      <Image
                        src="/images/blog/Presentation3.jpg"
                        alt="image"
                        fill
